                ...
                <div class="col-md-3">
                  <div class="form-group">
                    <label>Supervisor:</label>
                      <input type="text" class="form-control" name="supervisor" id="supervisor" placeholder="Enter Supervisor">
                    <span class="text-danger" id="errorspv" style="font-size:80%;display:none">Nama supervisor harus diisi</span>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                    <label>Manager:</label>
                      <input type="text" class="form-control" name="manager" id="manager" placeholder="Enter Manager">
                    <span class="text-danger" id="errormgr" style="font-size:80%;display:none">Nama manager harus diisi</span>
                  </div>
                </div>
                {{-- <div class="col-md-3">
                ...
                <div class="col-md-2">
                  ...
                  <div class="row " style="margin-top:5px">
                      <div class="col-md-12 float-right">
                        <button type="button" id="report" class="btn btn-block btn-success btn-xs2 float-right">Report</button>
                    </div>
                  </div>
